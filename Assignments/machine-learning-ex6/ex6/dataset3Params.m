...
errorMatrix = zeros(size(C_vector,2),size(sigma_vector,2));
...
minimum = min(min(errorMatrix));

[C_index,sigma_index] =find(errorMatrix==minimum);

C = C_vector(C_index);
sigma = sigma_vector(sigma_index);
